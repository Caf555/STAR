...
(function () {
    ...
    nodes.ch4_fin = {
        ...
        choices: [
            { text: "—— 第四章 完 ——", goto: "ch4_end_card" }
        ]
    };
    nodes.ch4_end_card = {
        location: "echo_bridge", chapterLabel: CH, travel: true,
        text: "感謝遊玩《星淵迴響》第三、四章(M4 里程碑)。\n\n本階段內容:緘默之環與第一弦、守夜人 VIGIL 兩次對峙、深井鐵證與公開/要挾抉擇、伊蓮娜入隊、星區災變與陣營結盟系統、隱藏夥伴回聲、VIGIL 三種結局(說服/駭入/擊敗)。\n\n最終章 M5:第五章〈弦心〉與四種結局——你這一路的每一個抉擇、每一份羈絆、每一個盟友,都將在弦的另一端結算。\n\n你可以繼續自由航行整備,或重新開始體驗其他出身與抉擇。",
        choices: [
