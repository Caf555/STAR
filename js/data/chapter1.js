...
(function () {
    ...
    nodes.ch1_site_04 = {
        location: "siren_beacon", chapterLabel: CH,
        text: "信標的基座上有一道**人為切割**的裂口——黑曜取走「樣品」的地方,切割面光滑得像鏡子。裂口通向信標內部,但深處被一道**still 完好的內層艙門**封著,門面上流動的紋路與你的碎片同源。\n\n你靠近的瞬間,碎片在皮袋裡劇烈地發起熱來——**它到家了。**",
        choices: [
    ...
    nodes.ch1_fin = {
        location: "echo_ship", chapterLabel: CH, travel: true,
        text: "感謝遊玩《星淵迴響》第一章〈墜落的信標〉(M2 里程碑)。\n\n本階段內容:SVG 星圖導航與燃料系統、燈塔站樞紐(商店/酒吧/船塢/支線)、RIVET 入隊、信標遺址探索與裂隙獸首戰。\n\n接下來的 M3 里程碑:夥伴好感與個人任務、科技樹與製造、艦船對戰,以及開放度最高的第二章〈弦上的低語〉——三段織界歌謠,任你排列的尋訪順序。\n\n你可以繼續自由航行(賽壬 ↔ 赫利俄斯),或重新開始體驗其他出身。",
        choices: [
